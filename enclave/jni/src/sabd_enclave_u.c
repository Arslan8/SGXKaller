...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_getenv(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_getenv((const char*)ms->ms_name);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_open(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_open((const char*)ms->ms_pathname, ms->ms_flags);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_execv(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_execv((const char*)ms->ms_pathname, ms->ms_argv_num, ms->ms_argv1, ms->ms_argv2, ms->ms_argv3);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_shm_open(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_shm_open((const char*)ms->ms_name, ms->ms_oflag, ms->ms_mode);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_shm_unlink(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_shm_unlink((const char*)ms->ms_name);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_syslog_chk(void* pms)
{
	...
	libsfuzz_ocall_syslog_chk(ms->ms_priority, ms->ms_flag, (const char*)ms->ms_format);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_snprintf_chk(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_snprintf_chk(ms->ms_str, ms->ms_maxlen, ms->ms_flag, ms->ms_stlen, (const char*)ms->ms_format);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_pthread_setspecific(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_pthread_setspecific(ms->ms_key, (const void*)ms->ms_value);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_libsfuzz_ocall_readlink(void* pms)
{
	...
	ms->ms_retval = libsfuzz_libsfuzz_ocall_readlink((const char*)ms->ms_pathname, ms->ms_buf, ms->ms_bufsiz);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_setrlimit(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_setrlimit(ms->ms_resource, (const struct rlimit*)ms->ms_rlim);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_dlsym(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_dlsym(ms->ms_handle, (const char*)ms->ms_symbol);
...
static sgx_status_t SGX_CDECL sabd_enclave_libsfuzz_ocall_write(void* pms)
{
	...
	ms->ms_retval = libsfuzz_ocall_write(ms->ms_fd, (const void*)ms->ms_buf, ms->ms_count);
